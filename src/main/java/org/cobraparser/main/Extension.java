...
public class Extension implements Comparable<Object>, NavigatorExtensionContext {
  ...
  /**
   * Gets the {@link org.cobraparser.ua.NavigatorExtension} implementation. It
  ...
  public void addURLStreamHandlerFactory(final URLStreamHandlerFactory factory) {
    ...
    org.cobraparser.main.PlatformStreamHandlerFactory.getInstance().addFactory(factory);
  }

  public UserAgent getUserAgent() {
    return org.cobraparser.request.UserAgentImpl.getInstance();
  }
